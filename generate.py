...
def GenerateCharacter(char, font_size, background_color, font_file, file_name=None):
    ...
    return char_image, (x, y, font_width, font_height)
...
def GenerateCharacters():
    ...
    for dirname, dirnames, filenames in os.walk(font_dir):
        ...
        for filename in filenames:
            ...
            font_file = os.path.join(dirname, filename)    
                ...
                for font_size in font_sizes:
                    if font_size > 0:
                        ...
                        for background_color in background_colors:
                            ...
                            GenerateCharacter(char, font_size, background_color, font_file, file_name)
                            # Increment counter
                            k = k + 1
